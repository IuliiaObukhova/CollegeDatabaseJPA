...
public class TestCRUDPeerTutorRegistration extends JUnitBase {
...
long result=getTotalCount(em,PeerTutorRegistration.class);
	...
	void test02_Create() {
		...
		et.commit();
long result=getCountWithId(em,PeerTutorRegistration.class,PeerTutorRegistrationPK.class, PeerTutorRegistration_.id,peerTutorRegistration.getId());
...
//		peerTutorRegistration2.setCourse(course);
	...
	void test08_DeleteDependecy() {
		...
		// Get the result as row count
		PeerTutorRegistration returnedPeerTutorRegistration = getWithId(em, PeerTutorRegistration.class,PeerTutorRegistrationPK.class,PeerTutorRegistration_.id,peerTutorRegistration.getId() );
		...
		em.merge(returnedPeerTutorRegistration);
		et.commit();
		returnedPeerTutorRegistration = getWithId(em, PeerTutorRegistration.class,PeerTutorRegistrationPK.class,PeerTutorRegistration_.id,peerTutorRegistration.getId());
		...
		// Get the result as row count*/
		long result = getCountWithId(em, PeerTutor.class,Integer.class,PeerTutor_.id,peerTutorId);
